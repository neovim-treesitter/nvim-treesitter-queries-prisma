# nvim-treesitter-queries-prisma

[![Validate Queries](https://github.com/neovim-treesitter/nvim-treesitter-queries-prisma/actions/workflows/validate.yml/badge.svg)](https://github.com/neovim-treesitter/nvim-treesitter-queries-prisma/actions/workflows/validate.yml)

Neovim tree-sitter queries for **prisma**, part of the
...
```jsonc
{
  ...
  "url": "https://github.com/tree-sitter/tree-sitter-prisma",
...
- [ ] Changes are scoped to `prisma` — do not include files for other languages
